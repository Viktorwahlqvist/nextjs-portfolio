...
function Button({ className, size = "default", children, ...props }: ButtonProps) {
  ...
  return (
    <button {...props} className={classes}><span className="relatie flex items-center justify-center gap-2">{children}</span></button>
  );
}
